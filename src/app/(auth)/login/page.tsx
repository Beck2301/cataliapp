      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-[var(--color-surface)] py-8 px-4 shadow-xl sm:rounded-2xl sm:px-10 border border-[var(--color-border)]">
          ...
          <form className="space-y-6" action={formAction}>
            {state?.error && (
              <div className="bg-red-50 text-red-600 border border-red-200 text-base p-3 rounded-lg flex items-center gap-2">
            ...
            <div>
              <label htmlFor="email" className="block text-base font-medium text-[var(--color-text-secondary)]">
                Correo electrónico
              </label>
              <div className="mt-1">
                <input
            ...
            <div>
              <label htmlFor="password" className="block text-base font-medium text-[var(--color-text-secondary)]">
                Contraseña
              </label>
              <div className="mt-1">
                <input
